...
namespace makcu {
    ...
    public:
        ...
        bool connect(const std::string& port = "", bool useHighSpeed = true);
        bool connectAutoDetect(const std::string& port = "");  // Try all baud rates
        void disconnect();
        bool isConnected() const;
        ConnectionStatus getStatus() const;

        // Async connection methods
        std::future<bool> connectAsync(const std::string& port = "", bool useHighSpeed = true);
